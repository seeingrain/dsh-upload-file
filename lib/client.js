...
`;
		...
		function FileLibraryWindow({ queue, sessionId, inputActions, useInput, openFile }) {
			...
			return react.default.createElement("span", {
				...
				className: "duf-lib-scroll",
				ref: scrollRef
			}, activeDrafts.length > 0 ? react.default.createElement("table", {
			...
			}, middleEllipsis(entry.absolutePath, 10, 36))), react.default.createElement("td", { className: "duf-lib-size" }, formatSize(entry.size)))))) : null)), menu ? react.default.createElement(FileMenu, {
				x: menu.x,
				y: menu.y,
				entry: menu.entry,
