...
`;
		...
		function FileLibraryWindow({ queue, sessionId, inputActions, useInput, openFile }) {
			...
			const insertReference = (0, react.useCallback)((displayName) => {
			...
			return react.default.createElement("span", {
			...
			}, react.default.createElement("div", { className: "duf-lib-header" }, react.default.createElement("span", { className: "duf-lib-title" }, `Workspace files${totalFiles ? ` (${totalFiles})` : ""}`), react.default.createElement("button", {
			...
			}, react.default.createElement("colgroup", null, react.default.createElement("col", { style: { width: 64 } }), react.default.createElement("col"), react.default.createElement("col", { style: { width: 72 } }), react.default.createElement("col", { style: { width: 132 } })), react.default.createElement("tbody", null, activeDrafts.map((d) => react.default.createElement("tr", { key: d.id }, react.default.createElement("td", null, react.default.createElement("span", { className: "duf-lib-icon" }, react.default.createElement(FileBadge, {
				name: d.displayName,
				small: true
			}))), react.default.createElement("td", null, react.default.createElement("span", {
				className: "duf-lib-name",
				title: d.displayName
			}, middleEllipsis(d.displayName, 14, 26)), react.default.createElement("span", { className: "duf-lib-name-sub" }, d.state === "uploading" ? `Uploading ${Math.round(d.progress * 100)}%` : d.state === "failed" ? d.errorCode ?? "Failed" : "Waiting")), react.default.createElement("td", { className: "duf-lib-size" }, formatSize(d.size)), react.default.createElement("td", null, react.default.createElement("div", { className: "duf-lib-progress-row" }, react.default.createElement("span", { className: "duf-lib-progress" }, react.default.createElement("i", { style: { width: `${Math.round(d.progress * 100)}%` } })), react.default.createElement("span", { className: "duf-lib-prog-pct" }, `${Math.round(d.progress * 100)}%`))))))) : null, attachments === null ? null : attachments.length === 0 && activeDrafts.length === 0 ? react.default.createElement("div", { className: "duf-lib-empty" }, "No files yet. Click \"Upload\" to add.") : attachments.length > 0 ? react.default.createElement("table", {
				className: "duf-lib-table",
				style: { tableLayout: "fixed" }
			}, react.default.createElement("colgroup", null, react.default.createElement("col", { style: { width: 64 } }), react.default.createElement("col"), react.default.createElement("col", { style: { width: 72 } }), react.default.createElement("col", { style: { width: 140 } })), react.default.createElement("tbody", null, attachments.map((entry) => react.default.createElement("tr", { key: entry.name }, react.default.createElement("td", null, react.default.createElement("span", { className: "duf-lib-icon" }, iconFor(entry))), react.default.createElement("td", null, react.default.createElement("span", {
				className: "duf-lib-name",
				title: entry.displayName
			}, middleEllipsis(entry.displayName, 14, 26)), react.default.createElement("span", {
				className: "duf-lib-name-sub",
				title: entry.absolutePath
			}, middleEllipsis(entry.absolutePath, 10, 36))), react.default.createElement("td", { className: "duf-lib-size" }, formatSize(entry.size)), react.default.createElement("td", null, react.default.createElement("div", { className: "duf-lib-actions" }, react.default.createElement("button", {
				className: "duf-lib-btn",
				type: "button",
				...
				className: "duf-lib-btn duf-lib-btn-danger",
				type: "button",
				title: "Delete file",
				onClick: () => {
					if (!window.confirm(`Delete "${entry.name}"? This removes the file from disk.`)) return;
					api.deleteAttachment(sessionId, entry.name).catch(() => {}).finally(() => setVersion((v) => v + 1));
				}
			}, "🗑️"))))))) : null))) : null);
		}
		const inject = [
