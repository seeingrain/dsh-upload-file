...
`;
		...
		function FileLibraryWindow({ queue, sessionId, inputActions, useInput, openFile }) {
			...
			return react.default.createElement("span", {
				...
				className: "duf-lib-table",
				style: { tableLayout: "fixed" }
			}, react.default.createElement("colgroup", null, react.default.createElement("col", { className: "duf-col-icon" }), react.default.createElement("col"), react.default.createElement("col", { className: "duf-col-size" }), react.default.createElement("col", { className: "duf-col-act" })), react.default.createElement("tbody", null, attachments.map((entry) => react.default.createElement("tr", { key: entry.name }, react.default.createElement("td", null, react.default.createElement("span", { className: "duf-lib-icon" }, iconFor(entry))), react.default.createElement("td", null, react.default.createElement("span", {
				className: "duf-lib-name",
